...
export default function AboutPage() {
  return (
    <Container maxWidth="xl" sx={{ overflowX: 'clip' }}>
      <Head title="About | icari" description="Buy, Sell, and Trade digital video games" />
      ...
      <main>
        <Stack mt={16} justifyContent="center" alignItems="center" spacing={2} sx={{ textAlign: 'center' }}>
          <Typography mb={8} variant="h1">
            <Image src={icariLogo} alt="icari logo" width={280} height={100} /> <br/> enables decentralized <br />
          ...
          <Stack justifyContent="center" pt={{ xs: 0, md: 4 }} width={{ xs: '90%', md: '65%' }}>
            ...
            <Typography variant="h4" mt={4} fontWeight={300}>
              For the first time, icari allows users to truly own their digital video games. Our goal is to provide
            ...
            <Typography variant="h3" mt={8}>
              <TextGradient>
                Owning your digital game
              </TextGradient>
            </Typography>
            <Typography variant="h4" mt={4} mb={{ xs: 6, md: 10 }} fontWeight={300}>
              icari utilizes blockchain technology to provide gamers with a means of true ownership of digital assets,
